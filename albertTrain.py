...
# Custom Model
class AlBERTWithFeatures(nn.Module):
    def __init__(self, num_numerical_features):
        super(AlBERTWithFeatures, self).__init__()
...
# Training
model = AlBERTWithFeatures(num_numerical_features=train_numerical_features.shape[1])
